...
HD_PWD='D:/task/Day1/code/logic_gate/logic_gate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log all_gates_bh.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source all_gates_bh.tcl
