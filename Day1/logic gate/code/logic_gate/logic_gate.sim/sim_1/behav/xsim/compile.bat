...
REM
REM Generated by Vivado on Sun Mar 29 11:00:13 +0530 2026
...
echo "xvlog --incr --relax -prj tb_all_gates_bh_vlog.prj"
call xvlog  --incr --relax -prj tb_all_gates_bh_vlog.prj -log xvlog.log
