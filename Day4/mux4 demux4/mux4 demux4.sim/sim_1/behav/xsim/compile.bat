...
REM
REM Generated by Vivado on Sun Apr 05 12:36:46 +0530 2026
...
echo "xvlog --incr --relax -prj tb_demux1x4_vlog.prj"
call xvlog  --incr --relax -prj tb_demux1x4_vlog.prj -log xvlog.log
