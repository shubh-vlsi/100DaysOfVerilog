...
HD_PWD='D:/placment/task/Day4/mux4 demux4/mux4 demux4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demux1x4_st.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demux1x4_st.tcl
