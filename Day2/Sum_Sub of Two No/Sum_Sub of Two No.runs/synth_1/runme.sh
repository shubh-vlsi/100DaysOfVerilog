...
HD_PWD='D:/placment/task/Day2/Sum_Sub of Two No/Sum_Sub of Two No.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_gl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_adder_gl.tcl
