...
HD_PWD='D:/placment/task/Day3/mux2X1 demux1X2/Mux2X1 Demux1X2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demux1x2_df.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demux1x2_df.tcl
